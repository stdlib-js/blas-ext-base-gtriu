...
var X=require('@stdlib/blas-base-assert-is-layout/dist'),Y=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),P=require('@stdlib/math-base-special-fast-max/dist'),y=require('@stdlib/error-tools-fmtprodmsg/dist'),Z=p();function _(o,a,v,q,n,i,x,r){var s,c,g,f,m,e;if(!X(o))throw new TypeError(y('nullFx',o));if(s=Y(o),s?e=v:e=a,i<P(1,e))throw new RangeError(y('nullJL',e,i));if(r<P(1,e))throw new RangeError(y('nullGM',e,r));return s?(c=i,g=1,f=r,m=1):(c=1,g=i,f=1,m=r),Z(a,v,q,n,c,g,0,x,f,m,0)}F.exports=_
